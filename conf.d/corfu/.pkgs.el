...
(add-to-list 'package-pinned-packages '(corfu . "gnu"))
(add-to-list 'package-pinned-packages '(corfu-terminal . "nongnu"))
(add-to-list 'package-pinned-packages '(kind-icon . "gnu"))
