...
#+begin_src emacs-lisp :export none
  ...
  (keymap-set ctl-c-map "5" ctl-c-f-map)
...
obtain this feature through ~diff-hl~[fn:15].
...
specifically, Emacs equipped with Magit[fn:16].  I am acquainted with
...
experimenting with Nix3.el[fn:17], an Emacs Nix Interface akin to Magit,
...
Emacs supports a variety of line-folding methods[fn:18], including:
...
~org-modern~[fn:19] to enhance the appearance of Org Mode headings by
...
extensive works.  I use ~org-sidebar-tree~[fn:20] to achieve this.
...
Markdown[fn:21], perhaps the most prevalent text markup language of the first
...
YAML[fn:22] is an exceedingly prevalent configuration language. Despite my
...
[fn:15] diff-hl, https://github.com/dgutov/diff-hl

[fn:16] Magit, https://magit.vc

[fn:17] Nix3.el, https://github.com/emacs-twist/nix3.el

[fn:18] Line Wrap, https://www.emacswiki.org/emacs/LineWrap

[fn:19] Modern Org Style, https://github.com/minad/org-modern

[fn:20] Org Side Tree, https://github.com/localauthor/org-side-tree

[fn:21] Markdown, https://daringfireball.net/projects/markdown/

[fn:22] YAML, https://yaml.org/
